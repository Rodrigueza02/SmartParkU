# ═══════════════════════════════════════════════════════════════════════════
# 🚀 Despliegue Rápido para PRUEBA (Cero Costos)
# ═══════════════════════════════════════════════════════════════════════════
...
Write-Host "═══════════════════════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
Write-Host "⚠️  IMPORTANTE - LEE ESTO:" -ForegroundColor Red
Write-Host ""
Write-Host "   ✅ Este despliegue usa tus CRÉDITOS GRATIS de Azure" -ForegroundColor Green
Write-Host "   ✅ NO pagarás NADA si eliminas todo al terminar" -ForegroundColor Green
Write-Host ""
Write-Host "   🚨 DESPUÉS DE PROBAR, DEBES ejecutar:" -ForegroundColor Yellow
Write-Host "      .\delete-all.ps1" -ForegroundColor Red
Write-Host ""
Write-Host "   Si olvidas eliminar, pagarás ~`$70/mes" -ForegroundColor Red
Write-Host ""

$confirm = Read-Host "¿Entendiste que debes eliminar todo después? (escribe 'SI')"
...
Write-Host "   Si eliminas al terminar:  `$0 (usa créditos gratis)" -ForegroundColor Green
Write-Host "   Si olvidas eliminar:      ~`$70/mes" -ForegroundColor Red
Write-Host ""
...
Write-Host ""
Write-Host "⏱️  Tienes TODO el tiempo que necesites para probar" -ForegroundColor Green
Write-Host ""
